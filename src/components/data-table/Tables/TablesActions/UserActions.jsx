...
import {DeleteUserAction} from "@/context/Features/Actions.js";
...
export const UserActions = ({UserId}) => {
    ...
    return (
       <>
           ...
           {open && <Add actionName={'Edit'} name={'Trainer'} setOpen={setOpen} open={open} addAction={(setOpen)=><EditUser setOpen={setOpen} UserId={UserId}/>}/>}
                   ...
                   <AlertDialogFooter>
                       ...
                       <AlertDialogAction
                           onClick={async () => {
                               ...
                               try {
                                   const response = await ActionsApi.DeleteUser(UserId)
                                   toast.dismiss(deletingLoader)
                                   if (response?.status === 200 && response.data) {
                                       dispatch(
                                          DeleteUserAction({id : UserId})
                                       )
